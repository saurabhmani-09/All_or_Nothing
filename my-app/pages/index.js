  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="AllOrNothing" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to AllOrNothing: A Random Winner Game!</h1>
